...
public class ArcType {
    ...
    protected List<TitleType> xlTitle;
    ...
    /**
     * Gets the value of the xlTitle property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the xlTitle property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getXlTitle().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<TitleType> getXlTitle() {
        if (xlTitle == null) {
            xlTitle = new ArrayList<TitleType>();
        }
        return this.xlTitle;
    }
