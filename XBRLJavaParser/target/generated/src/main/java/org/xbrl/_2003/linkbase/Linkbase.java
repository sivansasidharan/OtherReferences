...
public class Linkbase {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "extended", namespace = "http://www.xbrl.org/2003/XLink", type = JAXBElement.class),
        @XmlElementRef(name = "roleRef", namespace = "http://www.xbrl.org/2003/linkbase", type = JAXBElement.class),
        @XmlElementRef(name = "arcroleRef", namespace = "http://www.xbrl.org/2003/linkbase", type = JAXBElement.class),
        @XmlElementRef(name = "documentation", namespace = "http://www.xbrl.org/2003/linkbase", type = JAXBElement.class)
    })
