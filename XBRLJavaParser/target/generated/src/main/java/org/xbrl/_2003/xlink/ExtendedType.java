...
public class ExtendedType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "documentation", namespace = "http://www.xbrl.org/2003/XLink", type = JAXBElement.class),
        @XmlElementRef(name = "title", namespace = "http://www.xbrl.org/2003/XLink", type = JAXBElement.class),
        @XmlElementRef(name = "arc", namespace = "http://www.xbrl.org/2003/XLink", type = JAXBElement.class),
        @XmlElementRef(name = "locator", namespace = "http://www.xbrl.org/2003/XLink", type = JAXBElement.class),
        @XmlElementRef(name = "resource", namespace = "http://www.xbrl.org/2003/XLink", type = JAXBElement.class)
    })
